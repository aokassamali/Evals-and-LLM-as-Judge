...
def main() -> int:
    ...
    p.add_argument("--print_every", type=int, default=10, help="Pass through to run_batch.py")
    p.add_argument("--resume", action="store_true", help="Pass through to run_batch.py")
    p.add_argument(
        "--models",
        nargs="+",
        required=True,
