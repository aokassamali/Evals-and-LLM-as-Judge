...
# Make it easy to import from scripts/ without packaging yet
import sys
sys.path.append(str(Path(__file__).resolve().parent))

from run_judge import ModelSpec, run_judge  # noqa: E402
...
def infer_backend(model: str, backend_flag: str | None) -> str:
    if backend_flag:
        return backend_flag

    m = (model or "").lower()
    # Heuristic: treat "gpt-*" and "o*" style models as OpenAI.
...
def main() -> int:
    ...
    parser.add_argument("--backend", type=str, default=None, help="ollama|openai (optional; auto-infer if omitted)")
